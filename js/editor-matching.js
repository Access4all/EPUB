...
var classNames=['matchingActivity_leftList', 'matchingActivity_rightList'], num = oldLi.parentNode.querySelectorAll('li').length;
...
var data = {intro:introText, matches:{}, list1:[], list2:[]};
